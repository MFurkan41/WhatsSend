...
Icons = {
    "Download":getcwd()+"\\includes\\icons\\download.ico",
    "Standart":getcwd()+"\\includes\\icons\\icon.ico",
    "Uninstall":getcwd()+"\\includes\\icons\\unicon.ico",
    "Preview":getcwd()+"\\includes\\icons\\preview-icon.png",
    "Word":getcwd()+"\\includes\\icons\\word.png",
